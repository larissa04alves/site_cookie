	...
	<div class="mt-6 md:flex md:items-center md:justify-between">
		...
		<div class="relative mt-4 flex items-center md:mt-0">
			...
			<input
				type="text"
				placeholder="Search"
				class="block w-full rounded-lg border border-gray-200 bg-white py-1.5 pl-11 pr-5 text-gray-700 placeholder-gray-400/70 focus:ring-opacity-40 md:w-80 rtl:pl-5 rtl:pr-11"
			/>
		</div>
	</div>
